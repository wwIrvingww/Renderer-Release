...
pub fn vertex_shader(vertex: &Vertex, uniforms: &Uniforms) -> Vertex {
  // Transformar posición del vértice utilizando la matriz de modelo y la matriz de vista
  ...
  // Transformación combinada (vista y modelo)
  let transformed = uniforms.view_matrix * uniforms.model_matrix * position;
